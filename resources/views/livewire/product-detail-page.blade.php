          ...
          <div class="lg:pl-20">
            <div class="mb-8 [&>ul]:list-disc [&>ul]:ml-4">
              ...
              <p class="inline-block mb-6 text-4xl font-bold text-gray-700 dark:text-gray-400 ">
                <span>{{ Number::currency($product->price, 'IDR', 'Rp') }}</span>
            ...
            <div class="flex flex-wrap items-center gap-4">
              <button wire:click='addToCart({{$product->id}})' class="w-full p-4 bg-[#D97707] rounded-md lg:w-2/5 dark:text-gray-200 text-gray-50 hover:bg-[#D97707]/75 dark:bg-blue-500 dark:hover:bg-blue-700">
